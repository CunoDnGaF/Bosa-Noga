[Github Pages](https://cunodngaf.github.io/Bosa-Noga/)
...
![Header](./src/assets/header-menu.png)

![Footer](./src/assets/footer-menu.png)
...
![Frontpage](./src/assets/index-loading.png)
...
![Frontpage](./src/assets/index-loaded.png)

Общая схема:

![Frontpage](./src/assets/index-loaded-comments.png)
...
![Catalog](./src/assets/catalog.png)
...
![Search](./src/assets/search-comments.png)

По умолчанию поисковое поле скрыто, отображается только иконка:

![Search](./src/assets/search-closed.png)
...
![Search](./src/assets/search-catalog-comments.png)
...
![Item](./src/assets/catalog-item.png)
...
![Item](./src/assets/catalog-item-comments.png)
...
![Cart](./src/assets/cart-comments.png)
...
![Cart](./src/assets/cart-widget.png)
